    ...
    <div className="page-container">
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card" style={{ borderTopColor: "var(--color-peach)" }}>
            <div className="feature-icon" style={{ backgroundColor: "var(--color-peach)", color: "white" }}>🔄</div>
            <h3>Smart Routing</h3>
            <p>Intelligent patient routing based on queue conditions and priority levels.</p>
          </div>
          <div className="feature-card" style={{ borderTopColor: "var(--color-water)" }}>
            <div className="feature-icon" style={{ backgroundColor: "var(--color-water)", color: "white" }}>💬</div>
            <h3>Interactive Chat</h3>
            <p>Engaging chatbot interface for pre-arrival data collection.</p>
          </div>
          <div className="feature-card" style={{ borderTopColor: "var(--color-azure)" }}>
            <div className="feature-icon" style={{ backgroundColor: "var(--color-azure)", color: "white" }}>📊</div>
            <h3>Real-time Analytics</h3>
            <p>Monitor queue status and patient flow in real-time.</p>
          </div>
          <div className="feature-card" style={{ borderTopColor: "var(--color-air)" }}>
